  ...
  return (
    ...
    >
      <div className="dropzone-card">
        <p className="dropzone-kicker">Angiography Viewer</p>
        <h1>Conventional Angiography</h1>
        <p className="dropzone-copy">
          Load DICOM angiography sequences to review conventional catheter-based
          coronary angiograms. Supports cine playback, window/level adjustment, and
          basic measurements.
        </p>
